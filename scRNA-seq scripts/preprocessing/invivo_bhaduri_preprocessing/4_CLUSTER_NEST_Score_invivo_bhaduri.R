if(TRUE) { 
  ...
  combined.obj <- readRDS("integrated_bhaduri_GW141718_sampled.RDS")
  ...
  # add annotation #
  combined.obj$Region <- combined.obj$structure
  combined.obj$Region[combined.obj$Region %in% c("allocortex", "neocortex")] <- "dorsal telencephalon"
  combined.obj$Region[combined.obj$Region %in% c("hypothalamus", "thalamus")] <- "diencephalon"
  combined.obj$Region[combined.obj$Region %in% c("GE","claustrum")] <- "ventral telencephalon"
  ...
  nr_invitro <- c("dorsal telencephalon",
  ...
  saveRDS(umap, "umap_df_integrated_bhaduri_GW141718_sampled.RDS")
